...
<html> 
    ...
    if (is_added_base()){
        ...
        echo "<script>window.location.href = './info_change.php';</script>";  
    }
    ?>
        <div class="banner">
            <div class="page">
        ...
        <div class="page">
            <div class="mtop">
                ...
                <div class="rightbox">
                    <h2 class="mbox">基本信息 > 基本信息自主录入 </h2>
                    <div class="tag-info">
                        <ul id="ulStuInfoTag">
                            <li>
                                <a class="tag3" onclick href="./info_view.php">基本信息查询</a> 
                            </li>
                            <li>
                                <a class="tag2" onclick href="./info_change.php">基本信息修改</a> 
                            </li>
                            <li>
                                <a class="tag1" onclick href="./info_add.php">自主录入</a> 
                            </li>
                        </ul>
                    </div>
